...
urlpatterns = [
    ...
    #url(r'^panel/manager/addtogroup/(?P<pk>\d+)/(?P<name>.*)$', views.add_users_to_groups, name='add_users_to_groups'),
    url(r'^panel/manager/addtogroup/(?P<pk>\d+)/$', views.add_users_to_groups, name='add_users_to_groups'),
    url(r'^panel/manager/delgroup/(?P<pk>\d+)/(?P<name>.*)$', views.del_users_groups, name='del_users_groups'),
]